...
/*!40000 ALTER TABLE `produto_estocado` DISABLE KEYS */;
INSERT IGNORE INTO `produto_estocado` (`ID`, `ID_PRODUTO`, `ID_DEPOSITO`, `ENTRADA`, `SAIDA`, `NR_SERIE`) VALUES
	(1, 1, 1, '2023-08-16 16:52:24', NULL, '1-NR-01');
/*!40000 ALTER TABLE `produto_estocado` ENABLE KEYS */;
